...
{post.coverImage && (
  <div className="relative">
    <div className="w-full aspect-video overflow-hidden lg:px-[40px]"> {/* Using lg:px-[40px] for horizontal padding only */}
      <CoverImage
      ...
      {/* Back Link - Centered between cover image and title */}
      <div className="max-w-5xl mx-auto px-6 lg:px-8 py-0 text-center">
        <Link 
          href="/gallery" 
      ...
      <div className="relative overflow-hidden bg-[#f5f5f7]">
        ...
        <div className="relative z-10 py-0 bg-[#f5f5f7]">
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center space-y-0 bg-[#f5f5f7] pt-4">
            {/* Title - Single line, full display */}
            ...
            {post.author && (
              <div className="flex items-center justify-center gap-6 pt-4">
                ...
                <div className="w-px h-8 bg-[#050507]"></div>
      ...
      {/* Main Content */}
      <article className="max-w-4xl mx-auto px-6 lg:px-8 py-12 bg-[#f5f5f7]">
        {post.content?.length && (
            ...
            <div className="bg-white border-2 border-black p-6 lg:p-8">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl font-bold text-[#050507] mb-2">Written by {post.author.name}</h3>
