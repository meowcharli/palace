          ...
          <div className="flex flex-col md:flex-row gap-4">
            {recentPosts?.slice(0, 2).map((post) => (
              <Link 
                ...
                className="header-button bg-white text-black px-4 py-2 rounded-full text-[0.95rem] min-w-[200px] border border-gray-200 transition-colors duration-200 hover:bg-[#FFEFF4] hover:text-[#89131F]"
              >
                {post.title}
              </Link>
            ))}
