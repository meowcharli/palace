    ...
    <div className="fixed top-0 left-0 w-full z-50 pointer-events-none p-4">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          {/* Floating Logo with inversion effect using mix-blend-mode */}
          <Link 
            href="/" 
          ...
          >
            <div id="invert-logo" ref={invertLogoRef} className="logo-wrapper">
              <svg width="115" height="28" viewBox="0 0 419.17 94.81" xmlns="http://www.w3.org/2000/svg" 
                className="transition-all duration-300 hover:translate-y-[-1px] inverted-svg mix-blend-difference">
                <path 
