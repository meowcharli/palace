          ...
          <div className="flex items-center space-x-3 pointer-events-auto">
            ...
            <div ref={searchContainerRef} className="relative">
              {isSearchOpen ? (
                <div className="absolute right-0 top-0 flex items-center">
                  <form onSubmit={handleSubmit} className="flex items-center">
                    <input
                      ...
                      placeholder="Search..."
                      className="bg-gray-900 text-white border border-gray-700 rounded-md py-2 pl-4 pr-12 focus:outline-none focus:ring-2 focus:ring-gray-600 w-56"
                    />
                    <div className="absolute right-1 flex items-center space-x-1">
                      <button 
                        type="submit" 
                        className="text-gray-300 hover:text-white h-8 w-8 flex items-center justify-center"
                ...
                <button
                  onClick={toggleSearch}
                  className="bg-gray-900 hover:bg-gray-800 rounded-md shadow-lg w-12 h-12 flex items-center justify-center transition-all duration-200"
                  aria-label="Search"
                >
