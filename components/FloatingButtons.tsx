    ...
    <div className="fixed top-0 left-0 w-full z-50 pointer-events-none p-4">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <Link 
            href="/" 
            className="floating-btn bg-gray-900 hover:bg-gray-800 rounded-full shadow-lg p-3 transition-all duration-200 pointer-events-auto"
          >
            <svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 419.17 94.81" className="w-12 h-3">
          ...
          <div className="flex items-center space-x-3 pointer-events-auto">
            ...
            <div ref={searchContainerRef} className="relative">
              {isSearchOpen ? (
                <form onSubmit={handleSubmit} className="absolute right-0 top-0">
                  <input
                    ref={searchInputRef}
                    type="text"
                    value={searchQuery}
                    ...
                    placeholder="Search..."
                    className="bg-gray-900 text-white border border-gray-700 rounded-full py-2 pl-4 pr-12 focus:outline-none focus:ring-2 focus:ring-gray-600 w-48"
                  />
                  <button 
                    type="submit" 
                ...
                <button
                  onClick={toggleSearch}
                  className="bg-gray-900 hover:bg-gray-800 rounded-full shadow-lg p-3 transition-all duration-200"
                  aria-label="Search"
                >
