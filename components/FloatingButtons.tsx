    ...
    <div className="fixed top-0 left-0 w-full z-50 pointer-events-none p-4">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          {/* Logo Button (Left) - wider rectangle with fixed aspect ratio */}
          <Link 
            href="/" 
            className="floating-btn bg-gray-900 hover:bg-gray-800 rounded-md shadow-lg h-12 w-32 flex items-center justify-center transition-all duration-200 pointer-events-auto"
          >
            <svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 419.17 94.81" className="w-24 logo-svg" preserveAspectRatio="xMidYMid meet">
