...
function FloatingButtonsComponent({ isDraftMode = false }: FloatingButtonsProps) {
  ...
  useEffect(() => {
    ...
    // Add visibility class to html when component mounts
  ...
  // Handle exit preview mode with better error handling
  const handleExitPreview = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error('Failed to disable draft mode');
      }
    } catch (err) {
  ...
  useEffect(() => {
    if (!isSearchOpen || !isMounted) return;
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-start pointer-events-auto" style={{ gap: '0.2rem' }}>
              ...
              {isSearchOpen && (
                <div 
                  className="search-container mr-4" 
...
// Export as a dynamic component to ensure proper hydration
export default dynamic(() => Promise.resolve(FloatingButtonsComponent), {
  ssr: false
});